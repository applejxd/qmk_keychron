...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_FN] = LAYOUT_113_jis(
        ...
        RGB_TOG, G(S(KC_F23)), CUT_TEXT,    KC_END,   C(KC_R),  C(KC_T),  C(KC_V),  C(KC_Z), KC_TAB,     C(KC_O),   KC_UP,       SET_MARK,        ESC,  C(KC_ENT),            _______,    _______,    _______,     _______,    _______,  _______,  _______,
