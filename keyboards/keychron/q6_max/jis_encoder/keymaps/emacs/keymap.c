...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_BASE] = LAYOUT_113_jis(
        KC_ESC,    KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,     KC_MUTE,            KC_PSCR,G(S(KC_F23)),RGB_MOD, KC_F13,   KC_F14,   KC_F15,   KC_F16,
        KC_GRV,    KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,     KC_INT3,  KC_BSPC,  KC_INS,   KC_HOME,  KC_PGUP,  KC_NUM,   KC_PSLS,  KC_PAST,  KC_PMNS,
        KC_TAB,    KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,     KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,     KC_LBRC,  KC_RBRC,    KC_ENT,             KC_DEL,   KC_END,   KC_PGDN,  KC_P7,    KC_P8,    KC_P9,    KC_PPLS,
    ...
    [WIN_FN] = LAYOUT_113_jis(
        _______, KC_BRID,      KC_BRIU,     KC_TASK,  KC_FILE,  RGB_VAD,  RGB_VAI,  KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_MUTE,  KC_VOLD,  KC_VOLU,  RGB_TOG,           G(KC_G),  G(S(KC_F23)), RGB_RMOD,    RGB_SPD,  RGB_SPI,  RGB_HUD,  RGB_HUI,
        _______, BT_HST1,      BT_HST2,     BT_HST3,  DEEPL,    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______, _______,  _______,      _______,     _______,  _______,  _______,  _______,
     ...
     C(KC_LCTL), G(KC_DOWN),   OSL(WIN_CX), C(KC_C),  KC_PGDN,  KC_LEFT,  KC_DOWN,  KC_ENT,C(KC_COMM),C(KC_DOT),  C(KC_Z),  _______,C(KC_RSFT),                                KC_MS_UP,                 _______,  _______,  _______,  _______,
        _______,C(KC_LOPTN),   C(KC_LCMMD), _______,                      SET_MARK,                     _______,C(KC_RCMMD),C(KC_ROPTN),_______,KC_MS_BTN1,        KC_MS_LEFT, KC_MS_DOWN, KC_MS_RIGHT, KC_MS_BTN2,         _______          ),
