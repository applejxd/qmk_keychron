...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_BASE] = LAYOUT_113_jis(
        KC_ESC    ,  KC_F1     ,  KC_F2     ,  KC_F3   ,  KC_F4   ,  KC_F5   ,  KC_F6   ,  KC_F7   ,  KC_F8     ,  KC_F9    ,  KC_F10    ,  KC_F11    ,  KC_F12    ,  KC_MUTE   ,               KC_PSCR,     KC_SCRL   ,  KC_PAUS    ,  RGB_HUI   ,  RGB_SAI,  RGB_VAI,  RGB_SPI,
        S(KC_LBRC),  KC_1      ,  KC_2      ,  KC_3    ,  KC_4    ,  KC_5    ,  KC_6    ,  KC_7    ,  KC_8      ,  KC_9     ,  KC_0      ,  KC_MINS   ,  S(KC_SCLN),  _______   ,  KC_BSPC   ,  KC_INS,      KC_HOME   ,  KC_PGUP    ,  KC_NUM    ,  KC_PSLS,  KC_PAST,  KC_PMNS,
        KC_TAB    ,  KC_Q      ,  KC_W      ,  KC_E    ,  KC_R    ,  KC_T    ,  KC_Y    ,  KC_U    ,  KC_I      ,  KC_O     ,  KC_P      ,  KC_RBRC   ,  KC_NUHS   ,  KC_ENT    ,               KC_DEL,      KC_END    ,  KC_PGDN    ,  KC_P7     ,  KC_P8  ,  KC_P9  ,  KC_PPLS,
        MO(WIN_FN),  KC_A      ,  KC_S      ,  KC_D    ,  KC_F    ,  KC_G    ,  KC_H    ,  KC_J    ,  KC_K      ,  KC_L     ,  KC_SCLN   ,  S(KC_7)   ,  KC_INT3   ,                                                                    KC_P4     ,  KC_P5  ,  KC_P6  ,
        MO(US_SFT),  KC_Z      ,  KC_X      ,  KC_C    ,  KC_V    ,  KC_B    ,  KC_N    ,  KC_M    ,  KC_COMM   ,  KC_DOT   ,  KC_SLSH   ,  _______   ,  KC_RSFT   ,                                         KC_UP     ,                KC_P1     ,  KC_P2  ,  KC_P3  ,  KC_PENT,
        KC_LCTL   ,  KC_LGUI   ,  KC_LALT   ,  KC_LNG2 ,                        KC_SPC,                            KC_LNG1  ,  KC_RGUI   ,  KC_RALT   ,  MO(WIN_FN),  KC_RCTL,                  KC_LEFT,     KC_DOWN   ,  KC_RGHT    ,  KC_P0     ,            KC_PDOT          ),
    [WIN_FN] = LAYOUT_113_jis(
        ...
        _______   , BT_HST1    ,  BT_HST2   ,  BT_HST3 ,  P2P4G   ,  _______ ,  _______ ,  _______ ,  _______   ,  _______  ,  _______   ,  _______   ,  _______   ,  CHATGPT   ,  C(KC_BSPC),  _______,     _______   ,  _______    ,  _______   ,  _______,  _______,  _______,
        ...
        C(KC_LSFT), G(KC_DOWN) ,  OSL(WIN_CX), C(KC_C) ,  KC_PGDN ,  KC_LEFT ,  KC_DOWN ,  KC_ENT  ,  C(KC_COMM),  C(KC_DOT),  C(KC_Z)   ,  RGB_MOD   ,  C(KC_RSFT),                                         KC_MS_UP  ,                _______   ,  _______,  _______,  _______,
        _______   , C(KC_LGUI) ,  C(KC_LALT),  _______ ,                        SET_MARK,                          _______  ,  C(KC_RCMMD), C(KC_RALT),  _______   ,  KC_MS_BTN1,               KC_MS_LEFT,  KC_MS_DOWN,  KC_MS_RIGHT,  KC_MS_BTN2,            _______          ),
    [US_SFT] = LAYOUT_113_jis(
        S(KC_ESC) ,  S(KC_F1)  ,  S(KC_F2)  ,  S(KC_F3),  S(KC_F4),  S(KC_F5),  S(KC_F6),  S(KC_F7),  S(KC_F8)  ,  S(KC_F9) ,  S(KC_F10) ,  S(KC_F11) ,  S(KC_F12) ,  _______   ,               _______  ,   _______   ,  _______    ,  _______ ,  _______ ,  _______,  _______,
        S(KC_EQL) ,  S(KC_1)   ,  KC_LBRC   ,  S(KC_3) ,  S(KC_4) ,  S(KC_5) ,  KC_EQL  ,  S(KC_6) ,  S(KC_QUOT),  S(KC_8)  ,  S(KC_9)   ,  S(KC_INT1),  S(KC_MINS),  _______   ,  S(KC_BSPC),  _______  ,   _______   ,  _______    ,  _______ ,  _______ ,  _______,  _______,
        S(KC_TAB) ,  S(KC_Q)   ,  S(KC_W)   ,  S(KC_E) ,  S(KC_R) ,  S(KC_T) ,  S(KC_Y) ,  S(KC_U) ,  S(KC_I)   ,  S(KC_O)  ,  S(KC_P)   ,  S(KC_RBRC),  S(KC_NUHS),  S(KC_ENT) ,               _______  ,   _______   ,  _______    ,  S(KC_P7),  S(KC_P8),  S(KC_P9), _______,
        S(KC_LCTL),  S(KC_A)   ,  S(KC_S)   ,  S(KC_D) ,  S(KC_F) ,  S(KC_G) ,  S(KC_H) ,  S(KC_J) ,  S(KC_K)   ,  S(KC_L)  ,  KC_QUOT   ,  S(KC_2)   ,  S(KC_INT3),                                                                    S(KC_P4),  S(KC_P5),  S(KC_P6),
        _______   ,  S(KC_Z)   ,  S(KC_X)   ,  S(KC_C) ,  S(KC_V) ,  S(KC_B) ,  S(KC_N) ,  S(KC_M) ,  S(KC_COMM),  S(KC_DOT),  S(KC_SLSH),  _______   ,  S(KC_RSFT),                                         S(KC_UP)  ,                S(KC_P1),  S(KC_P2),  S(KC_P3), _______,
        S(KC_LCTL),  S(KC_LGUI),  S(KC_LALT),  _______ ,                        S(KC_SPC),                         _______  ,  S(KC_RGUI),  S(KC_RALT),  _______   ,  S(KC_RCTL),               S(KC_LEFT),  S(KC_DOWN),  S(KC_RGHT) ,  S(KC_P0),             _______          ),       
